...
void handle_gear_data(uint8_t *data, uint8_t len)
{
    ...
    if(gear_index < 8)
    {
    clcd_print(gear_arr[gear_index], (0xC0 + (3)));
    }
...
void handle_rpm_data(uint8_t *data, uint8_t len)
{
    ...
    clcd_putch(data[2],(0xC0 + (8)));
    clcd_putch(data[3],(0xC0 + (9)));
    }
}
...
void handle_indicator_data(uint8_t *data, uint8_t len)
{
    ...
    switch(data[0])
    {
        ...
        case 3:
            (PORTB = PORTB & ~0xC0);
            (PORTB = PORTB & ~0x03);
            clcd_putch('O',(0xC0 + (11)));
            clcd_putch('F',(0xC0 + (12)));
            clcd_putch('F',(0xC0 + (13)));
            break;
    }
}
